...
- [GitHub Issues](https://github.com/DilwarBot/Aloneyukkimusic/issues/new?assignees=&labels=question&template=SUPPORT_QUESTION.md&title=support%3A+)
- Contact options listed on [this GitHub profile](https://github.com/DilwarBot)
- [Telegram Support](https://t.me/The_Alone_Network)

If you want to say **thank you** or/and support active development of YukkiMusicBot:

- Add a [GitHub Star](https://github.com/DilwarBot/AloneYukkiMusic) to the project.
- Fork the Repo :)
